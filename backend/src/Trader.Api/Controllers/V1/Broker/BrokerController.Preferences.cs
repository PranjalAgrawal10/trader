...
public sealed partial class BrokerController
{
        ...
        CancellationToken ct)
    {
        if (body is null)
        {
            return Problem(
                title: "Invalid body",
                detail: "Send JSON { \"enabled\": bool, \"underlying\": \"nifty\"|…, \"optionSide\": \"CE\"|\"PE\", \"maxLots\": 1–10, \"expiry\": \"yyyy-MM-dd\"|null, \"stopLossPercent\": number, \"targetPercent\": number, \"stopLossEnabled\": bool, \"targetEnabled\": bool, \"trailEnabled\": bool, \"trailPoints\": number }.",
                statusCode: StatusCodes.Status400BadRequest);
        }
