...
{
    /// <inheritdoc />
    public partial class AddKiteFavoriteInstruments : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "KiteFavoriteInstruments",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_KiteFavoriteInstruments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_KiteFavoriteInstruments_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_KiteFavoriteInstruments_UserId_InstrumentToken",
                table: "KiteFavoriteInstruments",
