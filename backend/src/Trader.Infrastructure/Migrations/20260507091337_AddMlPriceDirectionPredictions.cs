...
{
    /// <inheritdoc />
    public partial class AddMlPriceDirectionPredictions : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "MlPriceDirectionPredictions",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MlPriceDirectionPredictions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MlPriceDirectionPredictions_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MlPriceDirectionPredictions_UserId_InstrumentToken_Interval_~",
