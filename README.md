...
- **Scalper preferences**: `GET /api/v1/broker/kite/scalper-settings` and `PUT /api/v1/broker/kite/scalper-settings` persist scalper UI defaults per user (interval/range/graph/volume + Safe Scalper toggle and N/M point values).
