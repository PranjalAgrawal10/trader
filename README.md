...
- On **Kite instruments** at **`/instruments`**, the chart toolbar includes **Candles**: green/red OHLC candlesticks; with Zerodha connected and a row selected on **Browse**, SignalR ticks update the **in-progress** bar for the chosen interval.
